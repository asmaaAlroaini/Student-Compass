class LessonModel {
  ...
  factory LessonModel.fromJson(Map<String, dynamic> json) {
    ...
    return LessonModel(
      ...
      unitId: lessonData['unit_id'] as int? ?? 0,
      subjectId: lessonData['subject_id'] as int? ?? 0,
      title: lessonData['title'] as String? ?? '',
      lessonNumber: lessonData['lesson_number'] as int? ?? 1,
